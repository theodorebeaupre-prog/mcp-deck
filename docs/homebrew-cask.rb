...
# Publish it in a tap repository (e.g. github.com/theodorebeaupre/homebrew-tap)
...
cask "mcp-deck" do
  ...
  url "https://github.com/theodorebeaupre/mcp-deck/releases/download/v#{version}/MCP-Deck-v#{version}.zip"
  name "MCP Deck"
  desc "Menu bar dashboard for MCP servers across Claude Desktop, Claude Code, and Cursor"
  homepage "https://github.com/theodorebeaupre/mcp-deck"
